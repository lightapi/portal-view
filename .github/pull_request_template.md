...
- [ ] Row and card action groups use the shared renderer. Page-level and toolbar buttons retain visible text labels in both modes; workflow and inline editing controls remain directly accessible.
