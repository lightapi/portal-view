  ...
  const columns = useMemo<MRT_ColumnDef<ConfigProductType>[]>(
    () => [
      ...
      { accessorKey: 'propertyValue', header: 'Property Value' },
      {
        ...
        Cell: ({ row }) => (<Tooltip title="Update Property"><IconButton onClick={() => navigate('/app/form/updateConfigProduct', { state: { data: { ...row.original } } })}><SystemUpdateIcon /></IconButton></Tooltip>),
      },
      {
