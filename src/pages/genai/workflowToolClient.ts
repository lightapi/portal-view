...
export function createWorkflowToolClient() {
        ...
        const response = await fetch(endpoint, {
            ...
            body: JSON.stringify({ jsonrpc: '2.0', id, method, params: {
                ...
                _meta: {
                    ...
                    'io.modelcontextprotocol/clientInfo': { name: 'light-portal-workflow', version: '1.0.0' },
                },
            } }),
    ...
    return {
        async findTool(name: string): Promise<GatewayWorkflowTool> {
            ...
            if (!Array.isArray(discovery?.supportedVersions) || !discovery.supportedVersions.includes(protocolVersion)) {
                throw new Error('Gateway does not advertise MCP 2026-07-28.');
            }
