...
export const llmAdminResources: ResourceDefinition[] = [
  ...
  {scope:'host',key:'aliases',label:'Aliases',listAction:'getLlmPublicAlias',createAction:'createLlmPublicAlias',updateAction:'updateLlmPublicAlias',deleteAction:'deleteLlmPublicAlias',createLabel:'Create public alias',createForm:'createPublicAlias',updateForm:'updatePublicAlias',formFields:['hostId','publicAliasId','environment','aliasName','operations','requiredCapabilities','requireExpectedEmbeddingSpace','embeddingWorkloadLane','maxInputTokens','maxOutputTokens','maxRequestBytes','dataClassification','loggingMode','piiMode','lifecycleStatus','replacementAliasId','aliasVisibility','boundAgentDefId','boundWorkloadPrincipal','aggregateVersion'],idField:'publicAliasId',columns:['environment','aliasName','aliasVisibility','boundAgentDefId','boundWorkloadPrincipal','operations','embeddingWorkloadLane','requireExpectedEmbeddingSpace','loggingMode','piiMode','lifecycleStatus']},
  ...
  {scope:'host',key:'pricing',label:'Pricing',listAction:'getLlmPricingVersion',createAction:'createLlmPricingVersion',updateAction:'updateLlmPricingVersion',deleteAction:'deleteLlmPricingVersion',createLabel:'Create pricing version',createForm:'createPricingVersion',updateForm:'updatePricingVersion',formFields:['hostId','pricingVersionId','providerDeploymentId','operation','pricingVersion','inputMicrosPerMillion','outputMicrosPerMillion','cachedInputMicrosPerMillion','effectiveTs','expiresTs','source','approvedBy','aggregateVersion'],idField:'pricingVersionId',columns:['providerDeploymentId','operation','pricingVersion','inputMicrosPerMillion','outputMicrosPerMillion','effectiveTs','source']},
