...
export const llmResources: ResourceDefinition[] = [
  ...
  {key:'aliases',label:'Aliases',listAction:'getLlmPublicAlias',createAction:'createLlmPublicAlias',updateAction:'updateLlmPublicAlias',deleteAction:'deleteLlmPublicAlias',idField:'publicAliasId',columns:['environment','aliasName','operations','loggingMode','piiMode','lifecycleStatus']},
