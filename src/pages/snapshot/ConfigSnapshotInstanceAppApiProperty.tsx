...
export default function ConfigSnapshotInstanceAppApiProperty() {
    ...
    const fetchData = useCallback(async () => {
        ...
        const cmd = {
            host: 'lightapi.net', service: 'config', action: 'getSnapshotInstanceAppApiProperty', version: '0.1.0',
            data: {
        ...
        try {
            ...
            console.log("Fetched Snapshot Instance App Api Properties:", json);
            setData(json.data || []);
    ...
    // Column definitions
    const columns = useMemo<MRT_ColumnDef<SnapshotInstanceAppApiPropertyType>[]>(
        () => [
    ...
    const table = useMaterialReactTable({
        ...
        renderTopToolbarCustomActions: () => (
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                <Typography variant="h6">Snapshot Instance APP API Properties</Typography>
                {snapshotId && (
