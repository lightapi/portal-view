...
export default function ConfigSnapshotFile() {
    ...
    const fetchData = useCallback(async () => {
        ...
        const cmd = {
            host: 'lightapi.net', service: 'config', action: 'getSnapshotInstanceFile', version: '0.1.0',
            data: {
        ...
        try {
            ...
            console.log("Fetched Snapshot Instance Files:", json);
            setData(json.data || []);
    ...
    // Column definitions
    const columns = useMemo<MRT_ColumnDef<SnapshotInstanceFileType>[]>(
        () => [
    ...
    const table = useMaterialReactTable({
        ...
        renderTopToolbarCustomActions: () => (
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                <Typography variant="h6">Snapshot Instance Files</Typography>
                {snapshotId && (
