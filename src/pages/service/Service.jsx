...
export default function Service(props) {
  ...
  }, [page, rowsPerPage, debouncedApiId, debouncedApiName, debouncedServiceId, debouncedApiType, debouncedApiDesc, debouncedOperationOwner, debouncedDeliveryOwner, debouncedRegion, debouncedBusinessGroup, debouncedLob, debouncedPlatform, debouncedCapability, debouncedGitRepo, debouncedApiTags, debouncedApiStatus]);
      ...
      <div>
        <TableContainer component={Paper}>
          <Table aria-label="collapsible table">
            <TableHead>
              <TableRow>
                <TableCell align="left"><input type="text" placeholder="Api Id" value={apiId} onChange={handleApiIdChange}/></TableCell>
                <TableCell align="left"><input type="text" placeholder="Service Id" value={serviceId} onChange={handleServiceIdChange}/></TableCell>
                <TableCell align="left"><input type="text" placeholder="Api Name" value={apiName} onChange={handleApiNameChange}/></TableCell>
                <TableCell align="left"><input type="text" placeholder="Api Type" value={apiType} onChange={handleApiTypeChange}/></TableCell>
                <TableCell align="left"><input type="text" placeholder="Api Desc" value={apiDesc} onChange={handleApiDescChange}/></TableCell>
                <TableCell align="left"><input type="text" placeholder="Ops Owner" value={operationOwner} onChange={handleOperationOwnerChange}/></TableCell>
                <TableCell align="left"><input type="text" placeholder="Dly Owner" value={deliveryOwner} onChange={handleDeliveryOwnerChange}/></TableCell>
                <TableCell align="left"><input type="text" placeholder="Region" value={region} onChange={handleRegionChange}/></TableCell>
                <TableCell align="left"><input type="text" placeholder="Biz Group" value={businessGroup} onChange={handleBusinessGroupChange}/></TableCell>
                <TableCell align="left"><input type="text" placeholder="Lob" value={lob} onChange={handleLobChange}/></TableCell>
                <TableCell align="left"><input type="text" placeholder="Platform" value={platform} onChange={handlePlatformChange}/></TableCell>
                <TableCell align="left"><input type="text" placeholder="Capability" value={capability} onChange={handleCapabilityChange}/></TableCell>
                <TableCell align="left"><input type="text" placeholder="Git Repo" value={gitRepo} onChange={handleGitRepoChange}/></TableCell>
                <TableCell align="left"><input type="text" placeholder="Api Tags" value={apiTags} onChange={handleApiTagsChange}/></TableCell>
                <TableCell align="left"><input type="text" placeholder="Api Status" value={apiStatus} onChange={handleApiStatusChange}/></TableCell>
