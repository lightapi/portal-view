...
export default function GroupPermission() {
  ...
  const taskContext = useMemo(
    ...
    [host, initialApiVersionId, initialEndpointId, initialGroupId, searchContext],
  );
    ...
    renderTopToolbarCustomActions: () => (
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
        <Button
          ...
          onClick={() => navigate(buildTaskAwareRoute('/app/form/createGroupPermission', searchParams, taskContext), {
            state: {
              data: {
                groupId: initialGroupId,
                apiVersionId: initialApiVersionId,
