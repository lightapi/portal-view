...
export default function ProductVersionProperty() {
  ...
  const handleDelete = useCallback(async (row: MRT_Row<ProductVersionPropertyType>) => {
    ...
    const cmd = {
      ...
      data: { hostId: row.original.hostId, productVersionId: row.original.productVersionId, propertyId: row.original.propertyId , aggregateVersion: row.original.aggregateVersion},
    };
  ...
  const table = useMaterialReactTable(usePortalActionTableOptions({
    ...
    renderRowActions: ({ row }) => <PortalActions row={row} actions={[
      {
        id: "delete-product-version-property",
        label: "Delete Product Version Property",
