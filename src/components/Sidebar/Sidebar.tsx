  ...
  */
  // ── Administration ────────────────────────────────────
  {
    ...
    children: [
      ...
      { id: 95, label: "OAuth Admin", role: "user oauth-client-admin oauth-admin", link: "/app/oauth/authClient", icon: <SecurityIcon />, children: [{ label: "Auth Provider", link: "/app/oauth/authProvider" }, { label: "Auth Client", role: "user oauth-client-admin", link: "/app/oauth/authClient" }, { label: "Workflow Bindings", role: "admin host-admin oauth-admin", link: "/app/oauth/workflowBinding" }, { label: "Sessions", link: "/app/oauth/authSession" }, { label: "Authorization Codes", link: "/app/oauth/authCode" }, { label: "Refresh Tokens", link: "/app/oauth/refreshToken" }, { label: "Session Audit", link: "/app/oauth/authSessionAudit" }] },
